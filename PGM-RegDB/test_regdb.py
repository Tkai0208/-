...
def main_worker(args):
    ...
    for trial in trial_list:
        # Save evaluation logs to a separate folder
        ...
        #checkpoint = load_checkpoint(osp.join(logs_dir_root+'/'+str(trial), 'full_model_with_subset_ratio_1_check_model_best.pth.tar'))
        #checkpoint = load_checkpoint(osp.join(logs_dir_root+'/'+str(trial), 'full_model_with_unified_loss_and_soft_label_loss_model_best.pth.tar'))
        #checkpoint = load_checkpoint(osp.join(logs_dir_root+'/'+str(trial), 'full_model_with_subset_ratio_1_check_model_best.pth.tar'))
        ...
        if trial == 1:
            ...
            all_cmc_v2 = all_cmc_v2 + cmc
            all_mAP_v2 = all_mAP_v2 + mAP
            all_mINP_v2 = all_mINP_v2 + mINP
    ...
    mAP = all_mAP / cnt
    mINP = all_mINP / cnt
    print('==> Visible to Thermal, All Average:')
    print('FC:     Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
           cmc[0], cmc[4], cmc[9], cmc[19], mAP, mINP))

    cmc = all_cmc_v2 / cnt
    mAP = all_mAP_v2 / cnt
    mINP = all_mINP_v2 / cnt
    print('==> Thermal to Visible, All Average:')
    print('FC:     Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
            cmc[0], cmc[4], cmc[9], cmc[19], mAP, mINP))
