...
def main():
    ...
    stage1_best_path = osp.join('logs', log_s1_name, save_name+'model_best.pth.tar')
...
def main_worker_stage2(args, log_s1_name, log_s2_name, save_name):
    ...
    checkpoint = load_checkpoint(osp.join('./logs/' + log_s1_name, save_name+'model_best.pth.tar'))
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        def generate_cluster_features(labels, features, cids):
            """
            Camera-aware cluster feature 计算（方案一）：
