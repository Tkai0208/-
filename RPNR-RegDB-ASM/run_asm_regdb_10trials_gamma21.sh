#!/bin/bash
# ASM Gamma 2.0/1.0 - 5 Trials Ablation (Paper Default)

echo "=========================================="
echo "ASM Training - 5 Trials Ablation"
echo "Gamma: gamma_v=2.0, gamma_a=1.0 (Paper Default)"
echo "=========================================="
...
echo ""
echo "All remaining trials 8-10 (gamma 2.0/1.0) completed!"
