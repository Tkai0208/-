...
class ClusterContrastTrainer_RPNR(object):
    ...
    def train(self, epoch, data_loader_ir, data_loader_rgb, data_loader_gray=None,
              optimizer=None, print_freq=10, train_iters=400, i2r=None, r2i=None):
        """
        Soft Matching OT版本：无GCR损失，无灰度加载器
        """
        self.encoder.train()
